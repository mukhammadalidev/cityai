...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # oxirgi 3 ta: has_edu_attendance, has_edu_materials, has_edu_portals
        plans = [
            ("Demo", SubscriptionPlan.Code.DEMO, 0, 0, 10, 1, 30, 100, False, False, False, False, False, False, False, False, False),
            ("Start", SubscriptionPlan.Code.START, 99_000, 0, 50, 2, 300, 1000, True, False, True, False, False, False, True, True, False),
            (
                "Business",
